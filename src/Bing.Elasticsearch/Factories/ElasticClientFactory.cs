...
namespace Bing.Elasticsearch.Factories
{
    ...
    public class ElasticClientFactory : IElasticClientFactory
    {
        ...
        /// <summary>
        /// 初始化一个<see cref="ElasticClientFactory"/>类型的实例
        /// </summary>
        ...
        public void OverlapIndex(string indexName)
        {
            ...
            _options.DefaultIndex = indexName;
        }
        ...
        {
            if (_options.IsCompatibleVersion())
                return $"{_options.DefaultIndex}.{typeof(TDocument).FullName}".Replace(".", "_").ToLower();
        ...
        /// 降级后的ES客户端
        /// </summary>
        public IElasticLowLevelClient LowLevelClient => GetLowLevelClient(_options.DefaultIndex);
    }
}
